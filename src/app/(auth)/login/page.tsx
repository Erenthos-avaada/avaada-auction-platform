...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true); setError(""); setReapply(false);
    try {
      ...
      if (data.reapply) setReapply(true);
        ...
        <div className="auth-card anim-up d1">
          ...
          {error && (
            <div className="anim-in" style={{
              ...
              borderRadius: "var(--radius-sm)", padding: "12px 14px", marginBottom: "18px",
              color: "var(--danger)", fontSize: "0.82rem",
            }}>
              <div style={{ display: "flex", gap: "8px", alignItems: "flex-start" }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ flexShrink: 0, marginTop: "1px" }}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                <div>
                  <p>{error}</p>
                  {reapply && (
                    <Link href="/register" style={{ display: "inline-block", marginTop: "8px", color: "var(--accent)", fontSize: "0.82rem", fontWeight: 600, textDecoration: "none" }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
            <div>
              ...
              <input className="input" type="email" placeholder="you@avaada.com"
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <button type="button" onClick={() => setShowPass(!showPass)} style={{
                  ...
                  background: "none", border: "none", cursor: "pointer", color: "var(--text3)", padding: 0, display: "flex",
                }}>
                  {showPass
